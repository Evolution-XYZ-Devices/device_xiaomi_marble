...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/displayconfig/thermal_brightness_control.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/displayconfig/thermal_brightness_control.xml
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/keylayout/Button_Jack.kl:$(TARGET_COPY_OUT_SYSTEM)/usr/keylayout/ukee-mtp-snd-card_Button_Jack.kl \
